        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-zinc-400">
              Access control plus a locked preset role pack.
            </p>
          </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[360px_1fr]">
          <div className="space-y-6">
            <div className="rounded-3xl border border-zinc-800 bg-zinc-900/80 p-5 shadow-2xl">
              ...
              <p className="mt-2 text-sm text-zinc-400">
                Paste a Discord user ID and choose whether they are an admin or a viewer.
              </p>
            ...
            <div className="rounded-3xl border border-zinc-800 bg-zinc-900/80 p-5 shadow-2xl">
              ...
              <p className="mt-2 text-sm text-zinc-400">
                These roles are locked and tied directly to their icons.
              </p>
              ...
              <div className="mt-5 space-y-3">
                {FIXED_ROLES.map((role) => (
                  <div
                    key={role.name}
                    className="flex items-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-950/60 p-3"
                  >
                      ...
                      <tr key={row.id} className="bg-zinc-950/60">
                        ...
                        <td className="px-3 py-3">
                          <form action={updateAllowedUserRole} className="flex items-center gap-2">
                            ...
                            <button
                              type="submit"
                              className="rounded-xl border border-zinc-700 bg-zinc-800 px-3 py-2 text-xs hover:bg-zinc-700"
                            >
                              Update
                            </button>
                          </form>
